        ...
        return (
            <div className='com_sabre_example_redapp_web_module_forms_service'>
                <div className='sample-form-container'>
                    <p>This is where the existing popover is extended and I can have a form or info here.</p>
                    <form onSubmit={this.handleSubmit} ref='form'>
                        <div className='fields-container'>{/**/}
                            <div className='row'>
                                <div className='form-group col-md-4'>
                                    <label>Room type</label>
                                    <input type='text' className='form-control' id='ipRoomType' placeholder='ROH' />
                                </div>

                                <div className='form-group col-md-4'>
                                    <label>Currency</label>
                                    <input type='text' className='form-control' id='ipCurrency' placeholder='USD' />
                                </div>
                            </div>
