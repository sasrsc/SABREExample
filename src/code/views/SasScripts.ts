...
import { SasScriptComponent } from "./SasScriptComponent";

@CssClass("com-sabre-example-redapp-web-module-forms-service btn btn-default")
@Initial({
  caption:
    '<i class="fa fa-edit"></i> <span class="hidden-xs dn-x-hidden-0-8">SAS Scripts</span>',
  type: "default",
})
export default class SasScripts extends AbstractBootstrapPopoverButton {
  private content = new StatelessComponent({
    componentName: "CommandMessagePopover",
    rootReactComponent: SasScriptComponent,
  });
