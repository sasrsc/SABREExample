...
export class GetResView extends AbstractView<AbstractModel> {
    ...
    selfSubmitModalAction(): void {
        ...
        const payload: string = "<GetReservationRQ Version='1.19.0' xmlns='http://webservices.sabre.com/pnrbuilder/v1_19'><Locator>UUYMYU</Locator><RequestType>Stateful</RequestType><ReturnOptions><ViewName>FullWithOpenRes</ViewName><ResponseFormat>STL</ResponseFormat></ReturnOptions></GetReservationRQ>";
        ...
        soapApi.callSws({
            ...
            $(responseValue).find('stl19\\:Passenger').each(function() {
