...
export class AfterSellPopover extends React.Component<
  AfterSellPopoverProps,
  AfterSellPopoverState
> {
  constructor(e) {
    super(e);
  ...
  handleExecute(): void {
    ...
    cf.sendCommandMessage(this.state.phoneNbr, true, true).then((res) => {
      cf.sendCommandMessage(this.state.ttl, false, false).then((res) => {
        cf.refreshTripSummary();
        this.closeLayer();
      });
    });
  }
    ...
    return (
      ...
      >
        ...
        <Input
          type="text"
          name="ttl"
          title="Ticket Time Limit"
          placeHolder="enter ticket time limit"
