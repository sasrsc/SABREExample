...
export class ShellPnrComponent extends React.Component<OwnProps, OwnState> {
  ...
  createPNR(): void {
    var pl =
      '<TravelItineraryAddInfoRQ Version="2.2.0" xmlns="http://webservices.sabre.com/sabreXML/2011/10" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">' +
      "        <AgencyInfo>" +
      "        <Address>" +
      ...
      "    </AgencyInfo>" +
      "            <CustomerInfo>" +
      "                <CustomerIdentifier>CST" +
      this.state.travelType +
      "2020</CustomerIdentifier>" +
      "                <PersonName>" +
      "                    <GivenName>" +
      this.state.passengerName +
      "</GivenName>" +
      "                    <Surname>" +
      this.state.passengerSurname +
      "</Surname>" +
      "                </PersonName>" +
      "            </CustomerInfo>" +
      "</TravelItineraryAddInfoRQ>";

    var pl1 = this.cfHelper.getXmlPayload("PassengerDetailsRQ", {
        ...
        AddRemarkRQ: this.cfHelper.getXmlPayload("AddRemarkRQ", {
          Remark: () => {
            ...
            strRmk = strRmk.concat(
              this.cfHelper.getXmlPayload("FOP_Remark", {})
            );
      ...
      TravelItineraryAddInfoRQ: this.cfHelper.getXmlPayload(
        "TravelItineraryAddInfoRQ",
        {
          ...
          CustomerInfo: this.cfHelper.getXmlPayload("CustomerInfo", {
            ...
            CustomerIdentifier: this.cfHelper.getXmlPayload(
              "CustomerIdentifier",
              { CustomerIdentifier: "CST" + this.state.travelType + "2020" }
            ),
    ...
    getService(CommFoundHelper)
      ...
      .then((res) => {
        ...
        if (res.errorCode !== undefined && res.errorCode !== null) {
          ...
          console.log(
            this.cfHelper.getXmlPayload("SabreCommandLLSRQ", {
      ...
      >
        <div className="form-group">
          ...
          <Input
            ...
            title="Surname"
            value={this.state.passengerSurname}
