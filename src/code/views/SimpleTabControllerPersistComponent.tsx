// copy of the persistence sample but needed a new name
...
export class SimpleTabControllerPersistComponent extends React.Component<
  { messageFromStore },
  OwnState
> {
  state: OwnState = {
...
export const SimpleTabControllerPersistComponentWithStore = connect<
  { messageFromStore },
  {},
  {}
>(mapStateToProps)(SimpleTabControllerPersistComponent);
