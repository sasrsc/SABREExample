...
/** @internal **/
export const context: IModuleContext = new ModuleContext("com-sabre-example-redapp-web-module");
/** @internal **/
...
/** @internal **/
export const t: ScopedTranslator = getService(I18nService).getScopedTranslator('com-sabre-example-redapp-web-module/translations');
